...
class PAW:
    ...
    def dump_vars(self):
        ...
        for state in self.ae_partial_wave:
            print("# ae_partial_wave_grid[%s] = %s" % (state, self.ae_partial_wave_grid))
            print("# ae_partial_wave[%s] = %s" % (state, self.ae_partial_wave))

        for state in self.pseudo_partial_wave:
            print("# pseudo_partial_wave_grid[%s] = %s" % (state, self.pseudo_partial_wave_grid))
            print("# pseudo_partial_wave[%s] = %s" % (state, self.pseudo_partial_wave))

        for state in self.projector_function:
            print("# projector_function_grid[%s] = %s" % (state, self.projector_function_grid))
            print("# projector_function[%s] = %s" % (state, self.projector_function))
